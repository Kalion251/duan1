...
<head>
    ...
    <link href="../assets/jsvendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <!-- Custom styles for this template-->
    <link href="../assets/css/sb-admin-2.min.css" rel="stylesheet">
    <link rel="stylesheet" href="../css/admin/head.css">
    <link rel="stylesheet" href="../css/admin/loaihang.css">
    <link rel="stylesheet" href="../css/admin/hanghoa.css">
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?act=dstk">
                    <i class="fas fa-fw fa-table"></i>
