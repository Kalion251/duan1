import validate, { email, requied, password, confirmPassword } from './validate.js';
validate({
  form: '#form-register',
  ...
  color: 'invalid',
  rules: [
    requied('#reg-username'),
    requied('#confirm-password'),
    requied('#reg-password'),
    password('#reg-password', 6),
    confirmPassword('#confirm-password', '#reg-password')
  ]
})
validate({
  form: '#form-login',
  ...
  color: 'invalid',
  rules: [
    requied('#login-username'),
    requied('#login-password'),
    password('#login-password', 6),
  ]
})
