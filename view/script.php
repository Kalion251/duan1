...
validate({
  form: '#form-register',
  group: '.auth-form__group',
  error: '.form-message',
  color: 'invalid',
  rules: [
    validate.requied('#reg-username'),
    validate.requied('#confirm-password'),
    validate.requied('#reg-password'),
    validate.password('#reg-password', 6),
    validate.confirmPassword('#confirm-password', '#reg-password')
  ]
})
validate({
  form: '#form-login',
  ...
  color: 'invalid',
  rules: [
    validate.requied('#login-username'),
    validate.requied('#login-password'),
    validate.password('#login-password', 6),
  ]
})
