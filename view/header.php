  ...
  <div class="grid">
    <nav class="header__navbar hide-on-mobile-tablet">
      ...
      <ul class="header__navbar-list open-auth-form-wrapper">
        ...
        <li class="header__navbar-item header__navbar-item--has-notif">
          ...
          <div class="header__notif">
            ...
            <ul class="header__notif-list">
                ...
                <a href="" class="header__notif-link">
                  ...
                  <div class="header__notif-item-info">
                    ...
                    <p class="header__notif-item-desc">Hidden Tag là giải pháp Xác thực hàng chính hãng bằng công
                      nghệ tiên tiến nhất hiện nay</p>
                  </div>
                </a>
              </li>
              <li class="header__notif-item">
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lipvtsddiyocac_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    ...
                    <p class="header__notif-item-desc">Một làn môi căng mềm, quyến rũ với sắc màu nổi bật luôn là
                      điều mà các quý cô ao ước</p>
                  </div>
                </a>
              </li>
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/e66cc386528d8c5119b59cd20ccacc22_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/3b4f85af7520eee6b2a2af269c5db485_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                    <p class="header__notif-item-desc">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                  </div>
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lifnzc0nz6qa0b_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                    <p class="header__notif-item-desc">Hidden Tag là giải pháp Xác thực hàng chính hãng bằng công
                      nghệ tiên tiến nhất hiện nay</p>
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/d278b6c4fdaf00c707629fa6bb230709_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Sale sốc bộ dưỡng Ohui The First tái tạo trẻ hóa da SALE OFF
                      70%</p>
                    <p class="header__notif-item-desc">Giá chỉ còn 375.000 vnđ (giá gốc: 1.250.000 vnđ)</p>
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/sg-11134201-7rbmj-lmwven0gtijndf_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Ohui chính thức ra mắt dòng son lì mới THE FIRST GENITURE
                      LIPSTICK</p>
                    <p class="header__notif-item-desc">Một làn môi căng mềm, quyến rũ với sắc màu nổi bật luôn là
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/3e8d9c3026ba61f43a6ae6b934cb183e_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                    <p class="header__notif-item-desc">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                  </div>
              ...
              <li class="header__notif-item">
                <a href="" class="header__notif-link">
                  <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lo3itgh8t9q2ae_tn" alt="" class="header__notif-item-img">
                  <div class="header__notif-item-info">
                    <p class="header__notif-item-name">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                    <p class="header__notif-item-desc">Xác thực chính hãng nguồn gốc các sản phẩm Ohui</p>
                  </div>
        ...
        ?>
          <!-- <li class="header__navbar-item">
            <label class="header__navbar-item-link header__navbar-item-link--strong open-auth-form item--separate">Xin Chào 
            </label>
          </li> -->

          <li class="header__navbar-item">
            <a href="#" class="header__navbar-item-link header__navbar-item-link--strong open-auth-form">Xin Chào <?= $user ?></a>
          </li>
          <?php if ($role == 1) { ?>
            <li class="header__navbar-item">
              <a href="admin/index.php" class="header__navbar-item-link header__navbar-item-link--strong open-auth-form">admin</a>
            </li>
          <?php } ?>
          <li class="header__navbar-item">
            <a href="index.php?act=thoat" class="header__navbar-item-link header__navbar-item-link--strong open-auth-form">Đăng Xuất</a>
          </li>
    ...
    <div class="modal">
      ...
      <div class="modal__body">
        ...
        <form class="auth-form" action="index.php?act=dangnhap" method="post">
          ...
          <div class="auth-form__form">
            <div class="auth-form__group">
              <input type="text" class="auth-form__input" placeholder="Email/Phone number" name="user">
              <span class="form-message"></span>
            </div>
            <div class="auth-form__group">
              <input type="pass" class="auth-form__input" placeholder="Password" name="pass">
              <span class="form-message"></span>
            </div>
            <div class="auth-form__help right-align">
              <a href="index.php?act=quenmk" class="auth-form__help-item auth-form__text-link item--separate item--separate-size-l">Quên
                mật khẩu</a>
          ...
          <div class="auth-form__social">
            ...
            <a href="#" class="btn--with-icon auth-form__social-google text-color-link">
              <img class="auth-form__social-icon" width="512" alt="Google &quot;G&quot; Logo" src="">
        ...
        <!-- Register form -->
        <form class="auth-form" action="index.php?act=dangky" method="post">
          <header class="auth-form__header">
          ...
          <div class="auth-form__form ">
            <div class="auth-form__group">
              <input type="email" class="auth-form__input" placeholder="Email/Phone number" name="email">
              <span class="form-message"></span>
            </div>
            <div class="auth-form__group">
              <input type="text" class="auth-form__input" placeholder="user name" name="user">
              <span class="form-message"></span>
            </div>
            <div class="auth-form__group">
              <input type="password" class="auth-form__input" placeholder="password" name="pass">
              <span class="form-message"></span>
            </div>
            ...
            <div class="auth-form__control right-align">
              ...
              <input class="btn btn--large btn--primary" type="submit" value="ĐĂNG KÝ" name="dangky"></input>
            </div>
          </div>
          <div class="auth-form__social">
            <a href="" class="btn--with-icon auth-form__social-facebook text-color-link">
    ...
    <div class="header__cart">
      <div class="header__cart-wrap select-hover-btn">
        ...
        <div class="header__notif header__cart-list header__cart-has-cart">
          ...
          <img class="header__cart-no-cart-img" src="" alt="">
            ...
            <li class="header__cart-item">
              <a href="#" class="header__cart-link">
                <div class="header__cart-item-left">
                  <img src="./assets/img/1.jpeg" alt="" class="header__cart-item-img">
